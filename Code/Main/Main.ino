/*
 * ============================================================================
 * COMPLETE AUTONOMOUS CAR CONTROLLER - ESP32 (IMPROVED VERSION 3)
 * ============================================================================
 * التحسينات الأخيرة:
 * - اعتماد الحساس المركزي (SENSOR_C) كأساس للكشف الأمامي بدلاً من المتوسط.
 * - تحسين منطق تجنب العوائق باستخدام الحساسات الثلاثة بشكل متكامل.
 * - التوقف الكامل عند وجود عائق ضمن المسافة الحرجة (50 سم).
 * - Follow Me يعتمد على جميع الحساسات لتتبع الهدف من أي اتجاه.
 * - زيادة سرعة الاستجابة وتحسين المنعطفات.
 * ============================================================================
 */
